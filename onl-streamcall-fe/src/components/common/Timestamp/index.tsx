...
const useStyles = makeStyles((theme: Theme) => {
  return {
    timestamp: {
      ...
      display: "flex",
      borderLeft: `1px solid ${theme.palette.primary.extraText}`,
      borderRight: `1px solid ${theme.palette.primary.extraText}`,
      padding: "0 30px",
      alignItems: "center",
      gap: "5px",
      "& > h6": {
...
const Timestamp: React.FC<{ type?: boolean; icon?: boolean; border?: boolean; time?: string }> = ({
  ...
  return (
    <div className={classNames(classes.timestamp, { [classes.clock]: icon }, { [classes.border]: border })}>
      {icon && <ClockIcon />}
