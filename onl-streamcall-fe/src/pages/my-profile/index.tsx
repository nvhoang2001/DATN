...
import ContentCopy from "@/components/common/ContentCopy";
            ...
            <div className={classes.info}>
              ...
              >
                ...
                <div className={classes.summaryInfo}>
                  <span>•</span>
                  <img src={MetamaskIconURL} alt="" width={24} height={24} />
                  <Typography>
                    {walletAddress ? (
                      <ContentCopy content={walletAddress}>{trimMiddlePartAddress(walletAddress)}</ContentCopy>
                    ) : (
                      "N/A"
                    )}
                  </Typography>
                  <Button
                    disableFocusRipple
                    onClick={walletActionManager}
                    style={{
                      display: walletActionButtonState === "HIDE" ? "none" : "",
                    }}
                  >
                    {walletActionButtonState === "NOT-CONNECT" ? "Connect Wallet" : "Update Wallet"}
                  </Button>
                </div>
              </div>
            </div>
