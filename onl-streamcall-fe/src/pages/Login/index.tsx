...
const Login: React.FC = () => {
  ...
  const { loginFormik, isNotInstallMetamask, loginWithMetamask } = useLogin();
    ...
    <Card elevation={4} className={classes.signinContainer}>
      <CardContent>
        ...
        >
          ...
          <Button
            className={classes.signInMetamaskBtn}
            fullWidth
            variant="contained"
            sx={{ mt: 3, mb: 2 }}
            disabled={isNotInstallMetamask}
            onClick={loginWithMetamask}
          >
            <Typography fontWeight={700}>Sign In With Metamask</Typography>
            <MetamaskIcon />
          </Button>
        </Box>
      </CardContent>
