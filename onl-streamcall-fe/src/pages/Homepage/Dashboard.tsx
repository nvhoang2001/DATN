...
const Dashboard: React.FC = () => {
  ...
  const contentCopy = () => {
    return `Meeting Link: ${location}/waiting-room/${roomId}
        ID: ${roomId}
    `;
  };
    ...
    <Stack spacing={3} className={classes.dashboardContainer}>
      <Box>
        <Typography mb={3} variant="h3" fontWeight={800} fontSize={"2.5rem"} className={classes.title}>
          Secure video conferencing <br /> for all purposes
        </Typography>

        <Typography mb={3} component="p" variant="body1" className={classes.subtitle}>
          Connect from anywhere at any time with Onl Video Call
        </Typography>
        ...
        >
          <Typography fontWeight={600}>Start a new meeting</Typography>
        </Button>
      ...
      <Box className={classes.form}>
        ...
        <Button className={classes.button} variant="contained" onClick={handleJoinMeeting} disabled={!linkCopy.value}>
          Join
        </Button>
      </Box>
        ...
        <div className={classes.contentDialog}>
          <div className={classes.header}>
            ...
            <Typography variant="body1">
              Here's your joining info <br />
              Send this to people you want to meet with. <br />
              You can click on the Meeting link to join the video call instantly.
            </Typography>
          </div>
      ...
      <BaseDialog open={openShare} onClose={() => setOpenShare(false)}>
        <div className={classes.contentDialog}>
          <DialogTitle>Please enter the email address to send the invitation</DialogTitle>
          <DialogContent>
            <TextField
              hiddenLabel
              variant="filled"
            ...
            <Button variant="contained" onClick={handleOpenShare}>
              Share
            </Button>
          </DialogContent>
        </div>
